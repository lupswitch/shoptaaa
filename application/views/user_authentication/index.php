...
<?php
if(!empty($authUrl)) {
	echo '<a href="'.$authUrl.'"><img src="'.base_url('assets/frontend/images/flogin.png').'" alt=""/></a>';
}else{
?>
<div class="wrapper">
    ...
    <div class="fb_box">
		<p class="image"><img src="<?php echo $userData['profileImage']; ?>" alt="" width="300" height="220"/></p>
		<p><b>Facebook ID : </b><?php echo $userData['oauth_uid']; ?></p>
		<p><b>Name : </b><?php echo $userData['firstName'].' '.$userData['lastName']; ?></p>
		<p><b>Email : </b><?php echo $userData['email']; ?></p>
		<p><b>Gender : </b><?php echo $userData['userGender']; ?></p>
