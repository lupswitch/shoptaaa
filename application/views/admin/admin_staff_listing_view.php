<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>admin/user-listing">Staff Listing</a></li>
      </ol>
    </section>
		...
		<div class="msg_noti"><?php echo $this->session->flashdata('verify_msg'); ?></div>
           <div class="box">
            <div class="box-header">
              <h2 class="box-title">List Of all Staff</h2>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="customer_listingTable" class="table table-bordered table-striped">
				...
				<?php $count ='1'; ?>
					<?php foreach( $all_Staff as $key =>$userVal): ?>   
						<tr>
