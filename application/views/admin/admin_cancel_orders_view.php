<div class="content-wrapper">
    ...
    <section class="content-header">
		<h1>  <i class="fa fa-<?php echo $font_icon; ?>"></i>
			<?php echo $pagetitle; ?>
			<small>View Cancel Orders</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>admin/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
			<li class="active"><a href="<?php echo base_url('admin/request-cancel'); ?>">Cancel Orders</a></li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				...
				<div class="box">
					<div class="box-header">
						<h2 class="box-title">List of all Request cancel orders</h2>
					</div>
					...
					<div class="box-body">
						...
						<table id="customer_listingTable" class="table table-responsive">
							...
							<tbody>
								...
								<?php
									$count = 1; 
									foreach($cancelOrderData as $od_data){
									...
									<tr>
										...
										<td><?php echo $od_data->cancelReason;  ?></td>
										...
										<td><?php if(!empty($od_data->totalPrice)) { echo $od_data->totalPrice; } else { echo "N/A"; } ?></td>
											...
											<td> 
												<a href="<?php echo base_url('admin/request-cancel-order-view/'.$od_data->o_id); ?>" class="btn btn-info">View</a>
											</td>
